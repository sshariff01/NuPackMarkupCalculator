...
public class MarkupConstants {
	...
	public static final double PHARMACEUTICAL_MARKUP = 0.075;

	public static final double FOOD_MARKUP = 0.13;

	public static final double ELECTRONICS_MARKUP = 0.02;
	...
	public static final String ELECTRONICS_CATEGORY = "electronics";
